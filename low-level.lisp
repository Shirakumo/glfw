...
(defglfwfun "glfwGetWindowAttrib" :int ((window :pointer) (attrib :int)))
...
(defglfwfun "glfwGetInputMode" :int ((window :pointer) (mode :int)))
(defglfwfun "glfwSetInputMode" :void ((window :pointer) (mode :int) (value :int)))
